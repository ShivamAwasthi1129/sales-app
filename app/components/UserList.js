  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all">
      <div className="px-5 py-4 border-b border-gray-200">
        <h2 className="text-lg font-bold text-blue-900">All Users</h2>
            ...
            {users.map((user) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    {["Admin", "Customer", "Sales Person"].includes(
                      user.role
                    ) ? (
                      user.companyId ? (
                        <button
                          onClick={() => setViewingCompany(user.companyId)}
                          className="inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800 border border-green-300 hover:bg-green-200 transition-colors"
                        >
                          <svg
                  ...
                  <td className="px-4 py-3 text-right text-sm font-medium">
                    <div className="flex items-center justify-end space-x-1">
                      {canEditUser ? (
                        <button
                          onClick={() => onEdit(user)}
                          className="inline-flex items-center px-2 py-1.5 text-xs font-medium text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-lg transition-colors"
                        >
                          <svg
                            className="w-4 h-4"
                            fill="none"
                      ...
                      {canDeleteUser ? (
                        <button
                          ...
                          className="inline-flex items-center px-2 py-1.5 text-xs font-medium text-red-600 hover:text-red-800 hover:bg-red-50 rounded-lg transition-colors"
                        >
                          <svg
                            className="w-4 h-4"
                            fill="none"
      ...
      {viewingCompany && (
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            {/* Header */}
            <div className="bg-blue-900 px-6 py-5 border-b border-gray-200">
                    ...
                    <div>
                      ...
                      <div className="space-y-3 text-sm">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 mt-1">
                            {companyData.getCompany.phone || "N/A"}
                          </p>
                        </div>
                        <div>
                          <span className="font-medium text-gray-700">
                          ...
                          <p className="text-gray-900 mt-1">
                            {companyData.getCompany.website || "N/A"}
                          </p>
                        </div>
                        <div>
                          <span className="font-medium text-gray-700">
                          ...
                          <p className="text-gray-900 mt-1">
                            {companyData.getCompany.industry || "N/A"}
                          </p>
                        </div>
                        <div>
                          <span className="font-medium text-gray-700">
                          ...
                          <p className="text-gray-900 mt-1">
                            {companyData.getCompany.address || "N/A"}
                          </p>
                        </div>
                        <div>
                          <span className="font-medium text-gray-700">
                          ...
                          <span
                            className={`ml-2 px-2 py-1 text-xs font-semibold rounded-full ${companyData.getCompany.status === "Active"
                      ...
                      <div className="space-y-3 text-sm">
                        <div>
                          ...
                          <p className="text-gray-900 mt-1">
                            ...
                            {companyData.getCompany.plan?.price || 0}/
                            {companyData.getCompany.plan?.billingCycle ||
                              "month"}
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-gray-900 mt-1">
                            {
                              companyData.getCompany.currentUsage
                                .salesPersonCount
                            }{" "}
                            /{" "}
                            {companyData.getCompany.planLimits.salesPersonLimit}
                          </p>
                        </div>
                        <div>
                          <span className="font-medium text-gray-700">
                          ...
                          <p className="text-gray-900 mt-1">
                            {companyData.getCompany.currentUsage.usersCount} /{" "}
                            {companyData.getCompany.planLimits.usersLimit}
                          </p>
                        </div>
                        <div>
                          <span className="font-medium text-gray-700">
                          ...
                          <p className="text-gray-900 mt-1">
                            {companyData.getCompany.currentUsage.quotationCount}{" "}
                            / {companyData.getCompany.planLimits.quotationLimit}
                          </p>
                        </div>
                        <div>
                          <span className="font-medium text-gray-700">
                          ...
                          <p className="text-gray-900 mt-1">
                            {new Date(
                              companyData.getCompany.createdAt
                            ).toLocaleDateString()}
                          </p>
                        </div>
                      </div>
