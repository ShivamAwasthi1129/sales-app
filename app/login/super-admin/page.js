  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = err.message ||
        ...
        'Login failed. Please check your credentials.'; // Generic error message
      ...
      <div className="w-full flex flex-col md:flex-row items-stretch h-full">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex items-center justify-center overflow-hidden">
          <div className="w-full max-w-sm flex flex-col justify-center">
            <h1 className="text-2xl font-semibold text-gray-900">Sign in as Super Admin</h1>
            <p className="text-sm text-gray-600 mt-2 mb-6">Enter your credentials to access the admin dashboard.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full text-white py-2 rounded-md font-medium shadow-sm disabled:opacity-60 bg-green-800"
                >
        ...
        <div className="hidden md:flex w-1/2 items-center justify-start relative overflow-hidden rounded-tl-3xl rounded-tr-3xl">
          ...
          <div className="absolute top-8 left-63 z-10">
            <p className="text-xs font-semibold text-gray-400 bg-white px-3 py-1 inline-block rounded-md border-2 border-gray-200">SALES STAR Admin Portal</p>
          </div>

          {/* Tagline */}
          <div className="absolute top-15 left-65 z-10 mt-4">
            <p className="text-sm font-bold text-gray-600">Complete system control with secure <br /><span className="text-green-600">admin access portal</span></p>
          </div>

          {/* Background gradient container */}
          <div className="absolute inset-y-0 right-0 left-1/5 bg-linear-to-b from-green-100 to-white rounded-tl-3xl" />
          <div className="absolute inset-0 bg-linear-to-l from-green-100/40 via-emerald-50/25 to-transparent" />
