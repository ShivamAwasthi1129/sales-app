...
export default function SalesDashboard() {
  ...
  const getStatusMapping = (businessStatus) => {
    ...
    return (
      mappings[businessStatus.toLowerCase()] || [businessStatus.toLowerCase()]
    );
  };
          ...
          <div className="space-y-2 flex-1">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-gray-400 font-semibold">
                    {analytics?.salesPersonName || user?.name || "Sales Person"}{" "}
            ...
            <p className="text-base mt-4 text-gray-700">
              ...
              <span className="font-bold text-blue-900">
                {user?.name || analytics?.salesPersonName || "Sales Person"}
              </span>
            </p>
          </div>
        ...
        <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500 mt-1 font-semibold">
                {stats?.conversionRate?.toFixed(1) || 0}% success rate
              </p>
            </div>
                      ...
                      <div className="absolute left-full ml-2 top-0 z-50 w-96 bg-white border border-gray-200 rounded-lg shadow-lg p-4 animate-fadeIn">
                        <div className="flex items-center justify-between mb-3 pb-2 border-b border-gray-200">
                          <div>
                            ...
                            <p className="text-xs text-gray-500 mt-0.5">
                              Showing {statusQuotations.length} of {item.value}{" "}
                              total
                            </p>
                          </div>
                          <span
                        ...
                        {statusQuotations.length > 0 ? (
                              ...
                              >
                                ...
                                <div className="flex items-center justify-between mt-1">
                                  <span className="text-xs text-gray-500">
                                    {quotation.salesPerson || user?.name}
                                  </span>
                              ...
                              >
                                <p className="text-xs text-gray-700">
                                  <span className="font-semibold">
                                    Click to view all {item.value} quotations
                                  </span>
                                </p>
                              </button>
                            )}
                          ...
                          <div className="text-center py-8 text-gray-500">
                            <p className="text-sm">
                              No recent {item.name.toLowerCase()} quotations
                            </p>
                            {item.value > 0 && (
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500 mt-1">Detailed insights</p>
              </div>
              <svg
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500 mt-1">Monitor progress</p>
              </div>
              <svg
